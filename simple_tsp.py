...
node_bonus = 10
hard_constraint_hor_penalty = 100
hard_constraint_ver_penalty = 100
...
print(f"{exact_status=}")
print(f"{exact_solution=}")
...
dwave_samples = dwave_sampler.sample_qubo(Q, num_reads=50, label='Study TSP')
